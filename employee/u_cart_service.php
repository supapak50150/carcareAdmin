...
if (isset($_GET['cus_id'])) {
  $select_stmt = $conn->prepare("SELECT * FROM cart_customer where cus_id=?");
  ...
  <div class="card">
    ...
    <div class="card-body bg-light ">
      ...
      <form action="" method="post">
        ...
        <?php
        $cus_id = $_GET['cus_id'];
        $select_stmt = $conn->prepare("SELECT * FROM cart_customer where cus_id=$cus_id");
        $select_stmt->execute([$_GET['cus_id']]);
        $result = $select_stmt->fetch(PDO::FETCH_ASSOC);
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <a href="u_cart_service_db.php?add_on_id=<?= $row['add_on_id']; ?>&ms_id=<?= $row['ms_id']; ?>&cus_id=<?php echo $cus_id; ?>" class="btn btn-outline-light btn-sm" style="background-color:#EE9A4D;">
            ...
            <div class="card">
              ...
              <div class="card-body  ">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center"><?= $row['add_onservice_charge']; ?></td>
                          <td><!----ลบ---->
                            <a href="u_cart_service_del.php?add_on_id=<?= $row['add_on_id']; ?>&ms_id=<?= $row['ms_id']; ?>&cus_id=<?php echo $cus_id; ?>" class="btn btn-outline-danger btn-sm">
                ...
                <div class="text-center">
                  <a href="u_order_list_sum.php?cus_id=<?php echo $cus_id; ?>&ms_id=<?php echo $ms_id; ?>" class="btn btn-success btn-lg">
                    บันทึกข้อมูล
                  </a>
                  <a href="u_cart_service_cancel.php?cus_id=<?php echo $cus_id; ?>" class="btn btn-danger btn-lg" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ยกเลิก</a>
