...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body bg-light ">
            <!---------------------------------------สรุปรายการ--------------------------------------------->
            <div class="card">
                <form action="u_order_list_sum_db.php" method="post">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="text-center">
                            <a class="btn btn-outline-primary btn-lg " href="u_cart_service.php?cus_id=<?php echo $cus_id; ?>&ms_id=<?php echo $ms_id; ?>">เพิ่มบริการเสริม</a>
                            <button class="btn btn-success btn-lg text-light" name="submit_order" type="submit">บันทึกข้อมูล</button>
                            <a href="u_order_list_del.php?cus_id=<?php echo $cus_id; ?>" class="btn btn-danger btn-lg" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ยกเลิก</a>
                        </div>
                        <!--------------------------------------------------------------------------------------------------------------------------------------->
                    </div>
                </form>
