          ...
          <div class="card bg-dark text-white" style="border-radius: 1rem;">
            <div class="card-body p-5 ">
              ...
              <div class="mb-md-8 mt-md-6 ">
                <form action="register_manager_db.php" method="post" enctype="multipart/form-data">
                  <h2 class="fw-bold mb-2 text-uppercase text-center">ลงทะเบียน..ผู้จัดการ</h2>
                  ...
                  <?php endif ?>
                      ...
                      <input hidden type="text" name="manager" value="Manager" class="form-control text-center" required>
                  ...
                  <div class="text-center">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 ">
                        <a class="btn btn-outline-danger btn-lg  btn-block" href="../logout.php">ออกจากระบบ</a>
